...
type ThirdServiceConf struct {
	...
	JaegerTrace ThirdJaegerTraceConf `mapstructure:"jaegerTrace" json:"jaegerTrace" yaml:"jaegerTrace"`
}
...
type ThirdJaegerTraceConf struct {
	IsOpen   int    `mapstructure:"isOpen" json:"isOpen" yaml:"isOpen"`
